...
inference_pipeline = pipeline(
    ...
    model='/home/zlf/FunASR/onnx_export/damo/speech_paraformer_asr_nat-zh-cn-16k-common-vocab8404-online',
    model_revision='v1.0.4',
    device='cpu'
)

model_dir = os.path.join(os.environ["MODELSCOPE_CACHE"], "damo/speech_paraformer_asr_nat-zh-cn-16k-common-vocab8404-online")
speech, sample_rate = soundfile.read(os.path.join(model_dir, "/dataset/speech/aishell/data_aishell/wav/test/S0764/BAC009S0764W0424.wav"))
